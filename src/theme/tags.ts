...
const tagTones: Record<string, TagTone> = {
  ...
  "Both exchanged cards": { backgroundColor: "#E0F2FE", color: "#0369A1" },
  ...
  "Received their card": { backgroundColor: "#FEF3C7", color: "#B45309" },
  "Sales tools": { backgroundColor: "#FEF3C7", color: "#B45309" },
  "Shared my card": { backgroundColor: "#ECFDF5", color: "#047857" },
