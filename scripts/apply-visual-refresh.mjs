...
try {
 ...
 await transaction(async db=>{
  ...
  for(const b of brandReferences){
   ...
   const media=['product','detail','product'].map((kind,i)=>({type:'image',url:url(`brands/${b.key}-${kind}.png`),title:b.topics[i],caption:i===0?b.headline:i===1?b.bio:b.cta,ctaLabel:i===1?'See the options':b.cta,ctaPrompt:b.topics[i],ctaColor:b.color}));
